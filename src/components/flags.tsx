export const FrFlag = () => {
    return (
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_270_55010)">
                <rect width="16" height="12" fill="white" />
                <path fillRule="evenodd" clipRule="evenodd" d="M11 0H16V12H11V0Z" fill="#F50100" />
                <path fillRule="evenodd" clipRule="evenodd" d="M0 0H6V12H0V0Z" fill="#2E42A5" />
...
export const ArFlag = () => {
    return (
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_270_55022)">
                <rect width="16" height="12" fill="white"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M0 0V12H16V0H0Z" fill="#E31D1C"/>
                <mask id="mask0_270_55022" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="16"
                      height="12">
    ...
    return (
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_270_54993)">
                ...
                <mask id="mask0_270_54993" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="16"
                      height="12">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 0V12H16V0H0Z" fill="white"/>
                </mask>
                <g mask="url(#mask0_270_54993)">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 0V3H16V0H0Z" fill="#C51918"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 9V12H16V9H0Z" fill="#C51918"/>
                    ...
                    <path fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="#C88A02"/>
                    <path fillRule="evenodd" clipRule="evenodd"
                          d="M3.12003 8.216H3.28803V8.496H2.28003V8.216H2.44803V7.992H3.12003V8.216Z" fill="#C88A02"/>
                    <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <path fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="#005BBF"/>
                    <mask id="mask1_270_54993" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="2" y="8"
                          width="2" height="1">
                        <path fillRule="evenodd" clipRule="evenodd"
                              d="M2.28003 8.496H3.28803V8.944C3.28803 8.944 3.16203 8.888 3.03603 8.888C2.91003 8.888 2.78403 8.944 2.78403 8.944C2.78403 8.944 2.65803 8.888 2.53203 8.888C2.40603 8.888 2.28003 8.944 2.28003 8.944V8.496Z"
                              fill="white"/>
                    </mask>
                    <g mask="url(#mask1_270_54993)">
                    </g>
                    ...
                    <path fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="#C88A02"/>
                    <path fillRule="evenodd" clipRule="evenodd"
                          d="M8.60801 8.216H8.77601V8.496H7.76801V8.216H7.93601V7.992H8.60801V8.216Z" fill="#C88A02"/>
                    <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <path fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="#005BBF"/>
                    <mask id="mask2_270_54993" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="7" y="8"
                          width="2" height="1">
                        <path fillRule="evenodd" clipRule="evenodd"
                              d="M7.76801 8.496H8.77601V8.944C8.77601 8.944 8.65001 8.888 8.52401 8.888C8.39801 8.888 8.27201 8.944 8.27201 8.944C8.27201 8.944 8.14601 8.888 8.02001 8.888C7.89401 8.888 7.76801 8.944 7.76801 8.944V8.496Z"
                              fill="white"/>
                    </mask>
                    <g mask="url(#mask2_270_54993)">
                    </g>
                    <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <path opacity="0.3" fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="#E1E5E8"/>
                    <mask id="mask3_270_54993" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="3" y="4"
                          width="5" height="5">
                        <path fillRule="evenodd" clipRule="evenodd"
                              d="M3.73602 4.63199H7.37602V7.9024C7.37602 7.9024 7.10564 8.99999 5.55602 8.99999C4.00641 8.99999 3.73602 7.87346 3.73602 7.87346V4.63199Z"
                              fill="white"/>
                    ...
                    <g mask="url(#mask3_270_54993)">
                        <rect x="3.73602" y="6.64798" width="1.848" height="2.184" fill="#FFC034"/>
                        <rect x="3.73602" y="4.57599" width="1.848" height="2.128" fill="#AD1619"/>
                        <rect x="5.52802" y="6.59198" width="1.848" height="2.128" fill="#AD1619"/>
                        <rect x="5.52802" y="4.63199" width="1.96" height="2.072" fill="#F1F9FF"/>
                        <path fillRule="evenodd" clipRule="evenodd"
                        ...
                        <path fillRule="evenodd" clipRule="evenodd"
                              ...
                              fill="#005BBF" stroke="#AD1619" stroke-width="0.583333"/>
                    </g>
                    <path fillRule="evenodd" clipRule="evenodd"
...
export const DeFlag = () => {
    return (
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_270_54982)">
                <rect width="16" height="12" fill="white"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M0 8H16V12H0V8Z" fill="#FFD018"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M0 4H16V8H0V4Z" fill="#E31D1C"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M0 0H16V4H0V0Z" fill="#272727"/>
            </g>
            <defs>
    ...
    return (
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_270_55029)">
                ...
                <mask id="mask0_270_55029" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="16"
                      height="12">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 0V12H16V0H0Z" fill="white"/>
                </mask>
...
export default {FrFlag, UsFlag,EsFlag,JaFlag,DeFlag,ArFlag};